...
int main(int argc, char** argv)
{
	...
	bee_opts.pub_key="/home/ucanadmin/Special-production/MQTT-CPABE/cpabe_publickey_hospital";
	bee_opts.priv_key="/home/ucanadmin/Special-production/MATT-CPABE/cpabe_secretkey_nurse";
